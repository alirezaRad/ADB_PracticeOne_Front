...
function WatchAll() {
    ...
    return (
        <div className="col-6 mt-3">
            <h3 className="py-2 mt-2 fw-bold text-black text-center border ">FirstIPNumber - Duration</h3>
            <table className="table border">
                ...
                {ips.map(ip => (
                    <tr key={ip.firstIPNumber}>
                        ...
                        <td className="text-center">{ip.avgDuration}</td>
                        <td className="text-center">{ip.totalDuration}</td>
                    </tr>
                ))}
                </tbody>
            </table>
